...
func Test_insertSt(t *testing.T) {
	...
	fs["yes"] = "no"
	fs["raw"] = Raw("now()")
	q, args := insertSt(DB_PG, "mytable", fs)
...
func Test_updateSt(t *testing.T) {
	...
	fs["yes"] = "no"
	fs["raw"] = Raw("now()")
	q, args := updateSt(DB_PG, "mytable", fs, "ok=$1", "ok")
...
func Test_insertStMssql(t *testing.T) {
	...
	fs["ok"] = "coral"
	fs["yes"] = "no"
	q, _ := insertSt(DB_MSSQL, "mytable", fs)
...
func Test_updateStMssql(t *testing.T) {
	...
	fs["ok"] = "coral"
	fs["yes"] = "no"
	q, _ := updateSt(DB_MSSQL, "mytable", fs, "ok=@p1", "ok")
...
func Test_insertStAccess(t *testing.T) {
	...
	fs["ok"] = "coral"
	fs["yes"] = "no"
	q, _ := insertSt(DB_ACCESS, "mytable", fs)
...
func Test_updateStAccess(t *testing.T) {
	...
	fs["ok"] = "coral"
	fs["yes"] = "no"
	q, _ := updateSt(DB_ACCESS, "mytable", fs, "ok=?", "ok")
